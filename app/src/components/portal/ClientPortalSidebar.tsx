  ...
  return (
    <>
      ...
      >
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active ? "bg-brand/10 text-brand dark:text-white" : "text-muted hover:bg-surface-2 hover:text-foreground"
                )}
              >
        ...
        <div className="border-t border-border p-3 text-xs text-muted">Client Portal</div>
      </aside>
    </>
  );
}
