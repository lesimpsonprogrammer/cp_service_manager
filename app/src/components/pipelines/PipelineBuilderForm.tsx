...
export function PipelineBuilderForm({
  dataSources,
}: {
      ...
      <Card className="p-5">
        ...
        <CardContent className="space-y-4 px-0 pb-0">
          <div>
            ...
            <Input id="name" name="name" required placeholder="BambooHR → Payroll DB" />
          </div>
          ...
          <div>
            ...
            <Input id="schedule" name="schedule" placeholder="0 * * * * (leave blank to run manually)" />
